//Project #2, Math Game;
//Due: 2025/11/26, Time: 2:04 AM
//My Self Solution, Second Project;
...
short ReadHowManyQuestions()
{
	...
	} while (NumberOfQuestions < 1 || NumberOfQuestions > 30);
...
{
	string arrOperationType[5] = { "Add", "Sub", "Mult", "Div", "MixOp" };
